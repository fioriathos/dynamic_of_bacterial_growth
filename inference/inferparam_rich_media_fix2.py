...
#file_to_analy='/Users/fiori/DoubleAdderArticle/PreProcessed/20180709_GW296_glucose8aa_r095_div.csv'
file_to_analy='/Users/fiori/DoubleAdderArticle/PreProcessed/20180709_GW296_glucose8aa_r098_div.csv'
#file_to_analy='/Users/fiori/DoubleAdderArticle/PreProcessed/20180711_GW296_glucose_r095_div.csv'
#sys.argv[1]
step = int(sys.argv[1])
#step=8
# minimal cell length
fil = 18#int(sys.argv[3])
#fil=24
...
boundary = [(1e-5,None),(1e-10,None),(1e-10,None),(1e-10,None)]
...
mod=mn.minimize_lengths(free={'sl2':s+s*r[0],'gamma':g+g*r[1],'sd2':a,'sm2':e+e*r[2]},fixed={'mlam':0.0141757},boundary=boundary)
bestpar =\
...
mb['step']=step
mb['filt']=fil
f = open("{}.pkl".format('rich_paper_fix2{}'.format(step)),"wb")
pickle.dump(mb,f)
f.close()
#mbp = mb['param']
#mbe = mb['error']
