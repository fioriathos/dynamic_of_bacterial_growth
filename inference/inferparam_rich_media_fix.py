...
boundary = [(1e-5,None),(1e-10,None),(1e-10,None)]
...
mod=mn.minimize_lengths(free={'sl2':s+s*r[0],'gamma':g+g*r[1],'sm2':e+e*r[2]},fixed={'sd2':a,'mlam':m},boundary=boundary)
bestpar =\
...
mb['step']=step
mb['filt']=fil
f = open("{}.pkl".format('rich_paper_fix{}'.format(step)),"wb")
pickle.dump(mb,f)
f.close()
#mbp = mb['param']
#mbe = mb['error']
