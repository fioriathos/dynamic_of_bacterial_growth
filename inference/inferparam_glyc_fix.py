...
file_to_analy ='/Users/fiori/DoubleAdderArticle/PreProcessed/20180706_GW296_glycerol37_r098_div.csv'
...
mb['step']=step
f = open("{}.pkl".format('glyc_paper_fix{}'.format(step)),"wb")
pickle.dump(mb,f)
f.close()
#mbp = mb['param']
#mbe = mb['error']
